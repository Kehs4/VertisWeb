...
function PartnerForm({ title, labels, partnerType }) {
    ...
    const [loadedPartnerId, setLoadedPartnerId] = useState<string | number | null>(null);
    ...
    const partnerIsLoaded = loadedPartnerId !== null;

    const initialFormState = useMemo(() => ({
        code: '', lgpdConsent: '', gender: '', status: '', name: '', nomeFantasia: '',
        document: '', priceTable: '', isMonthlyPayer: '', paymentDay: '', zipCode: '',
        street: '', number: '', complement: '', neighborhood: '', city: '', state: '',
        site: '', email1: '', email2: '', internetPassword: '', relationshipType: '',
        phones: Array(4).fill({ number: '', type: '' })
    }), []);
    ...
    const handleSubmit = (e) => {
        ...
        alert(`${title} salvo com sucesso! (Verifique o console para ver os dados)`);
        setFormMode('view');
                ...
                <div className="form-section">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px', paddingBottom: '25px' }}>
                        ...
                        <div className="form-actions">
                            <button type="button" className="action-button submit" onClick={handleNewClick}><AddIcon fontSize="small" />Novo</button>
                    ...
                    {!showDetails && !partnerIsLoaded && (
                        <div className="form-placeholder">
                            <p>Clique em "Novo" para cadastrar {title}, ou em "Pesquisar" para encontrar já existente.</p>
                        </div>
                    )}
                    ...
                    <div className="form-section">
                        <div className="form-row" style={{}}>
                            <div className="form-group" style={{ flex: 1 }}>
                                ...
                                <div className="input-with-icon">
                                    <QrCode2Icon />
                                    <input type="text" id="code" name="code" value={formData.code} onChange={handleChange} readOnly />
                                </div>
                            </div>
                            ...
                            <div className="form-group" style={{ flex: 1 }}>
                                ...
                                <div className="input-with-icon">
                                    <BadgeIcon />
                                    <input type="text" id="document" name="document" value={formData.document} onChange={handleChange} required readOnly={isReadOnly} />
                                </div>
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group" style={{ flex: 2 }}>
                                ...
                                <div className="input-with-icon">
                                    <PersonIcon />
                                    <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} required readOnly={isReadOnly} />
                                </div>
                            </div>
                            <div className="form-group" style={{ flex: 1 }}>
                                <label htmlFor="status">Situação</label>
                                <select id="status" name="status" value={formData.status} onChange={handleChange} disabled={isReadOnly}>
                        ...
                        {(partnerType === 'tutor' || partnerType === 'veterinario') && (
                            <div className="form-row">
                                <div className="form-group" style={{ flex: 1 }}>
                                    ...
                                    <div className="input-with-icon">
                                        <PriceCheckIcon />
                                        <input type="text" id="priceTable" name="priceTable" value={formData.priceTable} onChange={handleChange} readOnly={isReadOnly} />
                                    </div>
                                </div>
                                <div className="form-group" style={{ flex: 0.4 }}>
                                    <label>Mensalista</label>
                                    <div className="form-group">
                                        <select name="isMonthlyPayer" id="isMonthlyPayer" value={formData.isMonthlyPayer} onChange={handleChange} disabled={isReadOnly}>
                                ...
                                <div className="form-group" style={{ flex: 0.5 }}>
                                    ...
                                    <div className="input-with-icon">
                                        <CalendarTodayIcon />
                                        <input type="number" id="paymentDay" name="paymentDay" value={formData.paymentDay} onChange={handleChange} min="1" max="31" readOnly={isReadOnly} />
                                    </div>
                                </div>
                                <div className="form-group" style={{ flex: 1 }}>
                                    <label htmlFor="gender">Sexo</label>
                                    <select id="gender" name="gender" value={formData.gender} onChange={handleChange} disabled={isReadOnly}>
                        ...
                        {(partnerType === 'clinica' || partnerType === 'fornecedor') && (
                            <div className="form-row">
                                <div className="form-group" style={{ flex: 2 }}>
                                    ...
                                    <div className="input-with-icon">
                                        <StorefrontIcon />
                                        <input type="text" id="nomeFantasia" name="nomeFantasia" value={formData.nomeFantasia} onChange={handleChange} required readOnly={isReadOnly} />
                                    </div>
                                </div>
                                <div className="form-group" style={{ flex: 1 }}>
                                    <label htmlFor="priceTable">Tabela de Preço</label>
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-row">
                                    <div className="form-group" style={{ flex: 1 }}>
                                        ...
                                        <div className="input-with-icon"><MarkunreadMailboxIcon /><input type="text" id="zipCode" name="zipCode" value={formData.zipCode} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 3 }}>
                                        <label htmlFor="street">Logradouro</label>
                                        <div className="input-with-icon"><SignpostIcon /><input type="text" id="street" name="street" value={formData.street} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="number">Número</label>
                                        <div className="input-with-icon"><NumbersIcon /><input type="text" id="number" name="number" value={formData.number} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="complement">Complemento</label>
                                        <div className="input-with-icon"><AddHomeIcon /><input type="text" id="complement" name="complement" value={formData.complement} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="neighborhood">Bairro</label>
                                        <div className="input-with-icon"><LocationCityIcon /><input type="text" id="neighborhood" name="neighborhood" value={formData.neighborhood} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="city">Cidade</label>
                                        <div className="input-with-icon"><LocationCityIcon /><input type="text" id="city" name="city" value={formData.city} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 0.5 }}>
                                        <label htmlFor="state">Estado</label>
                                        <div className="input-with-icon"><PublicIcon /><input type="text" id="state" name="state" value={formData.state} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-row">
                                    <div className="form-group" style={{ flex: 2 }}>
                                        ...
                                        <div className="input-with-icon">
                                            <LanguageIcon />
                                            <input type="url" id="site" name="site" value={formData.site} onChange={handleChange} readOnly={isReadOnly} />
                                        </div>
                                    </div>
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="relationshipType">Relacionamento</label>
                                        <select id="relationshipType" name="relationshipType" value={formData.relationshipType} onChange={handleChange} disabled={isReadOnly}>
                                            <option value="">Selecione...</option>
                                ...
                                <div className="form-row">
                                    <div className="form-group" style={{ flex: 1 }}>
                                        ...
                                        <div className="input-with-icon"><EmailIcon /><input type="email" id="email1" name="email1" value={formData.email1} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="email2">E-mail 2</label>
                                        <div className="input-with-icon"><EmailIcon /><input type="email" id="email2" name="email2" value={formData.email2} onChange={handleChange} readOnly={isReadOnly} /></div>
                                    </div>
                                    <div className="form-group" style={{ flex: 1 }}>
                                        <label htmlFor="internetPassword">Senha Acesso Internet</label>
                                        <div className="input-with-icon">
                                            <LockIcon />
                                            <input type="password" id="internetPassword" name="internetPassword" value={formData.internetPassword} onChange={handleChange} readOnly={isReadOnly} />
                                        </div>
                                    </div>
                                </div>
                            </div>
